		...
		<view class="mask" v-if="maskState">
			...
			<view class="footer">
				...
				<view class="box" @click="clickScore">
					...
					<view class="text">{{ Number(currentInfo.score).toFixed(1) }}分</view>
				</view>
					...
					<view class="content">
						...
						<view class="row">
							...
							<view class="value roteBox">
								...
								<text class="score">{{ Number(currentInfo.score).toFixed(1) }}分</text>
							</view>
						</view>
		...
		<uni-popup ref="scorePopup" :is-mask-click="false">
			<view class="scorePopup">
				...
				<view class="content">
					...
					<text class="text">{{ Number(userScore).toFixed(1) }}分</text>
				</view>
...
let pagePath = '/pages/preview/preview';
let previewList;
onLoad(async (e) => {
	currentId.value = e.id;
	previewList = e.previewList;
	const storgClassList = uni.getStorageSync(previewList) || [];
	classList.value = storgClassList;
	classList.value = classList.value.map((item) => ({ ...item, picurl: item?.smallPicurl?.replace('_small.webp', '.jpg') }));
...
onUnload(() => {
	console.log('销毁preview', previewList);
